          ...
          <div className="flex items-center justify-between h-[68px] sm:h-[74px]">
            ...
            */}
            ...
            <button
              ...
              className="inline-flex items-center gap-2 bg-maroon hover:bg-maroon-dark hover:scale-[1.03] hover:shadow-lg text-white text-xs sm:text-sm font-semibold px-4 sm:px-5 py-2 sm:py-2.5 rounded-full transition-all duration-300 shrink-0"
            >
              <Phone size={15} />
              Contact Us
            </button>
