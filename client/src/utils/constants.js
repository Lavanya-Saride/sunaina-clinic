...
export const SITE_CONTENT = {
  hero: {
    clinicHeadline: 'Sunaina Obs and Gyn - Women Health and Wellness Clinic',
    ...
    description:
     ...
     clinicalGuidelines:
    'We follow RCOG (Royal College of Obstetricians and Gynaecologists) protocols and WHO guidelines, tailored to Indian conditions.',
    contact: 'Contact Us',
  ...
  appointment: {
    ...
    offline: 'Clinic Consultation',
    virtual: 'Virtual Consultation',
    preferredDate: 'Integrated Date',
    preferredTime: 'Integrated Time',
    ...
    paymentProcessing: 'Opening Payment...',
    submit: 'Book an Appointment',
    paymentError: 'Unable to start the payment. Please try again.',
    paymentVerificationError: 'Payment was received but could not be verified yet. Please try again in a moment.',
    paymentCancelled: 'Payment was cancelled. Please try again when you are ready.',
